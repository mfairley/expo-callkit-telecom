    ...
    items: [
      {
        ...
        poster: "/outgoing-call-ios-poster.webp",
      },
      {
        type: "image",
        label: "Incoming (banner)",
        src: "/incoming-call-banner-ios.webp",
      },
      {
        type: "image",
        label: "Incoming (full screen)",
        src: "/incoming-call-fullscreen-ios.webp",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        poster: "/outgoing-call-android-poster.webp",
      },
      {
        type: "image",
        label: "Incoming (banner)",
        src: "/incoming-call-banner-android.webp",
      },
      {
        type: "image",
        label: "Incoming (full screen)",
        src: "/incoming-call-fullscreen-android.webp",
      },
    ],
  },
];
